...
# ========== Job Config ==========
job_name="qwen2.5vl3b_75k_reward_qwen2.5_3b"
num_node=2
script_path="scripts/qwen2.5vl3b_75k_reward_qwen2.5_3b/training/launch.sh"
...
# Example with slurm:
#   srun --job-name=$job_name --gres=gpu:$gpu_count --nodes=$num_node \
