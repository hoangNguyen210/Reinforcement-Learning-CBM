...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if isinstance(pretrain_or_model, str):
            ...
            elif 'Qwen3-VL' in pretrain_or_model:
                from transformers import Qwen3VLForConditionalGeneration
                model_class = Qwen3VLForConditionalGeneration
            elif 'Qwen2.5-VL' in pretrain_or_model:
    ...
    def forward(
        ...
        if visual_inputs is not None:
            visual_inputs.pop('attention_mask', None)
            visual_inputs.pop('input_ids', None)

        output = self.model(sequences, attention_mask=foward_attention_mask, position_ids=position_ids, **visual_inputs)
