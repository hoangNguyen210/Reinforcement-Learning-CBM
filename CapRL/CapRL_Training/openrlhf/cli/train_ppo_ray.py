...
from openrlhf.utils.utils import timing
...
def train(args):
    ...
    if args.vllm_num_engines is not None and args.vllm_num_engines > 0:
        ...
        with timing('Vllm Init', logger=logger):
    ...
    with timing('Actor Init', logger=logger):
...
if __name__ == "__main__":
    ...
    # from DLight: remove pi_old calculation for online update
    parser.add_argument("--train_vlm", action="store_true", default=False)
    parser.add_argument("--len_penalty", type=float, default=None)
    parser.add_argument("--penalty_type", type=str, default="all_penal",help="selection: all_penal, max_penal")
    parser.add_argument("--remove_pi_old", action="store_true", default=False)
    parser.add_argument("--policy_up_loss", action="store_true", default=False)
    parser.add_argument("--token_loss", action="store_true", default=False)
    parser.add_argument("--debug_mode", action="store_true", default=False)
    parser.add_argument("--replace_zero", action="store_true", default=False)
    parser.add_argument("--reward_type", type=str, default='math',)
    parser.add_argument("--exp_mode", type=str, default='cap',)
    ...
    parser.add_argument("--format_weight", type=float, default=0.0)
    parser.add_argument("--cap_v2_weight", action="store_true", default=False)
    parser.add_argument("--cap_v2_only_cap", action="store_true", default=False)
    parser.add_argument("--cap_v2_norm", action="store_true", default=False)
    parser.add_argument("--cap_v2_multi_qa", action="store_true", default=False)
    parser.add_argument("--think_cap", action="store_true", default=False)
    parser.add_argument("--hint_cap", action="store_true", default=False)
    parser.add_argument("--relax_format", action="store_true", default=False)
    parser.add_argument("--cap_remote_reward", action="store_true", default=False)
    parser.add_argument("--n_caps_per_prompt", type=int, default=4)
