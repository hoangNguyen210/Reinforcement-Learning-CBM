#!/bin/bash
# Stage 1: Further Pretraining with CapRL-2M caption data
...
# ========== Job Config ==========
export JOB_NAME=caprl_further_pretrain
...
# ========== Cache ==========
export tokenized_path=${LLAMAFACTORY_DIR}/cache/caprl_pretrain_cache
...
export model_name_or_path=/path/LLaMA-Factory/ckpt/Qwen2.5-VL-3B-pretrain-pt_llava558
