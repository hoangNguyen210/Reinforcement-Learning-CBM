...
# Worker: ray start --address='172.31.13.66:6379'
# ray status
...
ray job submit --address="http://172.31.13.66:8265" \
    --runtime-env=third_party/verl/verl/trainer/runtime_env.yaml \
    --no-wait \
    -- \
    python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=./data/verl/med-vlm-m23k-qwen2_5_vl_3b-easy_to_hard/train.parquet \
    ...
    trainer.experiment_name='train-qwen2_5_vl_32b-m23k' \
