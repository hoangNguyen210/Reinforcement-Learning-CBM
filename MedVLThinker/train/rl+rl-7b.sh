...
MODEL=outputs/converted/qwen2_5_vl_7b-m23k-step_320
ENGINE=vllm
...
# data/verl/med-vlm-m23k-qwen2_5_vl_7b-easy_to_hard/train.parquet  23,456
# data/verl/med-vlm-pmc_vqa-qwen2_5_vl_7b-easy_to_hard/train.parquet  176,896
...
python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='train-qwen2_5_vl_7b-pmc_vqa-m23k_rl' \
